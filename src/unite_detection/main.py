...
class TrainConfig(BaseModel):
    ...
    ckpt_monitor: Literal[
        "MulticlassAveragePrecision", "MulticlassAccuracy", "AUROC"
...
def init_yaml(path: Path = Path("./example.yaml"), run_name: str | None = None):
...
def train(config_path: Path = Path("./example.yaml"), resume: bool = False):
